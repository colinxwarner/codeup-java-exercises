...
public class Post {
    ...
    public String returnAuthorDateMessage() {
        return String.format("This post was created by %s on %s", title, numberOfPostViews);
    }
    ...
    // Static Methods:
    //This takes in two different post objects and returns the longer title
    //Dealing strictly with info passed into it but doest have anything to do with any specific blog post
    //Just a helper method. Could have gone in its own class
